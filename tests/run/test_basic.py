...
def make_insert(
    ...
    def inner(n: int) -> ZSet[int]:
        (out,) = st.iteration(store, graph, (ZSetPython(int, {n: 1}),))
        return out
...
def test_definition_3_27(conns: Conns, store_maker: StoreMaker) -> None:
    ...
    actual = insert(8)
    assert actual == ZSetPython(int, {8: 1})
    actual = insert(6)
    assert actual == ZSetPython(int, {8: 1, 6: 1})
    actual = insert(4)
    assert actual == ZSetPython(int, {8: 1, 6: 1, 4: 1})
    actual = insert(5)
    assert actual == ZSetPython(int, {8: 1, 6: 1, 4: 1, 5: 1})
    actual = insert(4)
    assert actual == ZSetPython(int, {8: 1, 6: 1, 4: 2, 5: 1})
...
def test_definition_3_25(conns: Conns, store_maker: StoreMaker) -> None:
    ...
    actual = insert(3)
    assert actual == ZSetPython(int, {3: 1})
    actual = insert(4)
    assert actual == ZSetPython(int, {3: -1, 4: 1})
    actual = insert(5)
    assert actual == ZSetPython(int, {4: -1, 5: 1})
...
def test_theorem_3_30_a(conns: Conns, store_maker: StoreMaker) -> None:
    ...
    actual = insert(5)
    assert actual == ZSetPython(int, {5: 1})
